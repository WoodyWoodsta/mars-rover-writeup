  ...
  \subsection{Mechanical Design}
    ...
    \subsubsection{Suspension}
      ...
      \subheading{Wheels}\\\\
        ...
        \centering
        \subfloat[]{
          \includegraphics[clip, trim=6cm 16cm 6cm 1cm, width=.4\linewidth]{figures/tire-outer}
        }
        \qquad
        \subfloat[]{
        ...
        \centering
        \subfloat[]{
          \includegraphics[clip, trim=6cm 16cm 6cm 1cm, width=.4\linewidth]{figures/tire-mid}
        }
        \qquad
        \subfloat[]{
    ...
    \subsubsection{Differential}
      ...
      \begin{figure}[h!]
      \centering
      \subfloat[Top view\label{fig:mechDesign-differentialMotion-a}.]{\includegraphics[clip, trim=2cm 19cm 2cm 3cm, width=0.9\linewidth]{figures/mechDesign-differentialMotionTop.pdf}}
      \qquad
      \subfloat[Side view.]{
      ...
      \subheading{Final Sub-assembly}\\\\
        ...
        \subfloat[\label{fig:mechDesign-differentialSubDetail-a}]{
          \includegraphics[clip, trim=3cm 22cm 3cm 0cm, width=0.85\linewidth]{figures/diff-sub}
        }
        \qquad
        \subfloat[\label{fig:mechDesign-differentialSubDetail-b}]{
          \includegraphics[clip, trim=4cm 17cm 4cm 1cm, width=0.6\linewidth]{figures/diff-sub-iso}
        }
