  ...
  \section{The Mars Science Laboratory and Curiosity}
    ...
    \subsection{Curiosity Technical Breakdown}
      ...
      \subsubsection{Mechanical Structure}
        \textit{Curiosity} is a six-wheeled, small-car-sized rover vehicle that is the mechanical combination of the three previous Mars rovers, specifically with respect to the mobility system. The core of the rover, here-onwards referred to as the ``body'', is a box structure shielding the avionics and other sensitive subsystems from the harsh climate of Mars.
