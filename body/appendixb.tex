\chapter{Contents of Submitted DVD}
  ...
  \begin{itemize}
    ...
    \item \textbf{Folder - \mintinline{js}{media}:}
      ...
      \end{itemize}
    \item \textbf{Git Repository - \mintinline{js}{mars-rover-writeup}:} The \LaTeX~source for this report. Also available online at \url{https://github.com/WoodyWoodsta/mars-rover-writeup/tree/thesis}.
