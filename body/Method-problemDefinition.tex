...
\label{sec:probDef-devObjectives}
    ...
    \label{subsec:probDef-vehicleSpecifications}
      \begin{itemize}
        ...
        \begin{RM}
          ...
          \begin{RM}
            \item Be as dimensionally accurate as possible to the \textit{Curiosity} rover on Mars.
        ...
        \begin{RE}
          ...
          \begin{RE}
            ...
            \item Have the ability to be switched off or on.
